...
LocationListener{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(parking_lot).title("Lawn Mowing")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)));
        LatLng chick = new LatLng(35.299584, -120.659891);
        mMap.addMarker(new MarkerOptions().position(chick).title("House Exterior painting")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));
        LatLng oahu_church1 = new LatLng(35.296167, -120.659820);
        mMap.addMarker(new MarkerOptions().position(oahu_church1).title("Lawn Mowing")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)));
